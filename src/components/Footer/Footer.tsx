            ...
            <div className={cl.footer__container}>
                <div className={cl.subscription}>
                    <div className={cl.subscription__logo}>
                        <img src="src\assets\images\footer\sultan.svg" alt="СУЛТАН" />
                    </div>
                    ...
                    <form id='email-sub' onSubmit={e => e.preventDefault()}>
                        <label htmlFor='email-sub'>Подпишись на скидки и акции</label>
                        <div className={`${cl.input} ${cl.subscription__input}`}>
                            <input type="email" name='email-sub' placeholder='Введите ваш E-mail' />
                            <button form='email-sub' type='submit'><img src="src\assets\images\footer\arrow.svg" alt="" /></button></div>
                    </form>
                </div>
                <nav>
                    <h4>Меню сайта:</h4>
                ...
                <div className={cl.info}>
                    ...
                    <ul>
                        ...
                        <li className={cl.info__messengers}>
                            ...
                            <a href=""><img src="src\assets\images\footer\whatsapp.svg" alt="WhatsApp" /></a><a href=""><img src="src\assets\images\footer\telegram.svg" alt="Telegram" /></a>
                        </li>
                    </ul>
                </div>
                <div className={cl.contacts}>
                    ...
                    <ul>
                        ...
                        <li className={cl.contacts__payment}>
                            <img src="src\assets\images\footer\visa.svg" alt="Visa" /><img src="src\assets\images\footer\mastercard.svg" alt="Master Card" />
                        </li>
                    </ul>
                </div>
            </div>
